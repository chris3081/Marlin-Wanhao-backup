...
//
  ...
  #define X_SERIAL_TX_PIN    PC10 // "2.6" on LCD/SD/SPI (aka AUX3)
  #define X_SERIAL_RX_PIN    PC10
  #define Y_SERIAL_TX_PIN    PC11 // "1.31" on LCD/SD/SPI
  #define Y_SERIAL_RX_PIN    PC11
  #define Z_SERIAL_TX_PIN    PC12 // "1.23" on LCD/SD/SPI
  #define Z_SERIAL_RX_PIN    PC12
  #define E0_SERIAL_TX_PIN   PC14 // "RX" on AUX1
